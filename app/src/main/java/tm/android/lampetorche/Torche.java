...
public class Torche extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!flashEnabled){
			LinearLayout layout = findViewById(R.id.layoutWrap);
...
//	}
	...
	private void tgl_btn_flash_onClick(View view){
	...
	private void chk_box_sos_onClick(View view){
		...
		ToggleButton flash = findViewById(R.id.tgl_btn_flash);
	...
	static void setModeSOS(boolean modeSOS) {
